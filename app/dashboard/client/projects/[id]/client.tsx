          ...
          >
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                <Card
                  key={i}
                  className="bg-card/50 backdrop-blur-sm border-muted/60 hover:border-purple-500/30 transition-colors"
                >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.technology.map((tech, index) => (
                        <Badge
                          key={`tech-${index}`}
                          variant="secondary"
                          className="px-3 py-1 bg-purple-500/10 text-purple-600 hover:bg-purple-500/20 border-purple-200/20"
                        >
                          {tech}
                        </Badge>
                      ))}
              ...
              <CardHeader className="px-0 pt-0">
                <div className="flex justify-between items-center">
                  <div>
                    ...
                    <CardDescription>
                      Manage and review freelancer bids.
                    </CardDescription>
                  </div>
                ...
                {bids.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-12 text-center border-2 border-dashed rounded-xl bg-muted/20">
                    ...
                    <p className="text-muted-foreground max-w-sm mt-2">
                      Freelancers will submit proposals here. Check back soon!
                    </p>
                  </div>
                ) : (
                  bids.map((bid) => {
                          ...
                          <div className="flex-1 space-y-3">
                              ...
                              <div>
                                <h3 className="font-semibold text-base">
                                  {bid.freelancer
                                    ? bid.freelancer.name
                                    : bid.freelancerId &&
                                      typeof bid.freelancerId === "object"
                                    ? (bid.freelancerId as any).name
                                    : "Unknown Freelancer"}
                                </h3>
                            ...
                            <div className="pl-13 md:pl-0">
                              <div className="flex items-center gap-4 mb-3 text-sm">
                                <span className="font-medium bg-secondary/50 px-2 py-1 rounded text-secondary-foreground">
                                  Bid: ${bid.amount}
                                </span>
                                {(bid.freelancer?.hourlyRate ||
                                  (bid.freelancerId as any)?.hourlyRate) && (
                              ...
                              <>
                                {bid.resumeUrl && (
                                  <Button
                                    ...
                                    variant="outline"
                                    onClick={() =>
                                      window.open(bid.resumeUrl, "_blank")
                                    }
            ...
            <Card className="border-none bg-transparent shadow-none">
              <CardHeader className="px-0 pt-0 flex flex-row justify-between items-center">
                <div>
                  ...
                  <CardDescription>
                    Review work submitted for sprints.
                  </CardDescription>
                </div>
                <Button
                  variant="outline"
              ...
              <CardContent className="px-0 space-y-4">
                {workSubmissions.length === 0 ? (
                  <div className="flex flex-col items-center justify-center py-12 text-center border-2 border-dashed rounded-xl bg-muted/20">
                    ...
                    <p className="text-muted-foreground max-w-sm mt-2">
                      Freelancers will submit their completed sprint work here
                      for your review.
                    </p>
                  </div>
                ) : (
                  workSubmissions.map((submission) => (
                    <div
                      key={submission._id}
                      className="p-5 border rounded-xl bg-card/60 backdrop-blur-sm shadow-sm hover:shadow-md transition-all"
                    >
                      <div className="flex justify-between items-start mb-4">
                        <div>
                          <div className="flex items-center gap-2 mb-1">
                            <h3 className="font-semibold text-lg text-foreground">
                              {submission.sprint
                                ? submission.sprint.title
                                : submission.sprintId &&
                                  typeof submission.sprintId === "object"
                                ? (submission.sprintId as any)?.title
                                : "Sprint Work"}
                            </h3>
                            <Badge
                              className={
                        ...
                        <div className="flex gap-2">
                          {submission.status !== "approved" && (
                            <Button
                              size="sm"
                              onClick={() => handleApproveWork(submission._id)}
                          ...
                          <Button
                            size="sm"
                            variant="outline"
                            onClick={() => handleRequestMeeting(submission._id)}
                          >
                            Request Meeting
                          </Button>
                        </div>
