...
import WorkSubmission from "@/components/features/tasks/work-submission";
    ...
    <div className="min-h-screen bg-background overflow-hidden relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        <div className="space-y-8 py-8">
          ...
          >
            <h1 className="text-4xl font-bold text-foreground">Submit Work</h1>
            <p className="text-muted-foreground mt-2">
              Submit your completed work for review
            </p>
          </motion.div>

          <WorkSubmission projectId={id} project={project} />
