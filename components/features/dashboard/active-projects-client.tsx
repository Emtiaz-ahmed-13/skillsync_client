                ...
                if (projectResponse.ok) {
                  ...
                  if (projectData.success && projectData.data) {
                    return {
                      ...
                      description: projectData.data.description || "Project description",
                                        ...
                                        <TableRow key={project._id} className="hover:bg-muted/50">
                                            ...
                                            <TableCell className="text-right">
                                                <Button 
                                                    variant="ghost" 
                                                    size="sm"
                                                    onClick={() => router.push(`/dashboard/freelancer/active-projects/${project.id}`)}
                                                >
                                                    View Details
                                                </Button>
                                            </TableCell>
