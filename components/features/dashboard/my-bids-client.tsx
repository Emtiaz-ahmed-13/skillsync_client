                            ...
                            <Table>
                                <TableHeader>
                                    <TableRow>
                                        ...
                                        <TableHead className="text-right">Submitted Info</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
                                    {bids.map((bid) => (
                                        <TableRow key={bid.id || bid._id} className="hover:bg-muted/50">
                                            <TableCell className="font-medium">{bid.projectTitle || "Unknown Project"}</TableCell>
                                            <TableCell>
